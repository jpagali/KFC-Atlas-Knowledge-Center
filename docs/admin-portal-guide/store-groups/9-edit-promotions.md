...
Updates the promotion assignments or settings within a store group.
...
**Step 4:** Click Edit Promotions

**Step 5:** Make more selections or remove stores that already selected

**Step 6:** Click assign when finished (this will only be enabled after you make a change)
