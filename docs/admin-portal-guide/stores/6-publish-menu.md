...
Triggers a menu publish directly from the Stores menu view, pushing the current configuration live.
...
**Step 6:** Click this more button and then hit “Publish Menu”

**Step 7:** Click “publish” to publish the menu.
...
- Stores -  Publish Menu on Menu Page
