...
Attaches custom metadata to a promotion for system integration or market-specific tracking needs.

## Steps

**Step 1:** Start by going to the Promotions screen by clicking here.

**Step 2:** Find the promotion you’d like to update the metadata for, click the action button, then click “Meta”
...
- You will be taken to a wizard style page to edit both public and private metafields.
